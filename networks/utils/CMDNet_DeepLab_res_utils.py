...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.chx2 = nn.Conv2d(filters[0] + filters[0], filters[0], 1, padding=0)
        self.chx2b = nn.BatchNorm2d(filters[0])
    ...
    def _forward(self, x):
        ...
        #print(x1.size()) 
        xd = self.maxpool4(x) 
        #print(x.size(),xd.size(),x1.size()) 
        x1 = torch.cat([xd,x1],dim=1)
        x1 = self.chx1(x1)
        x1 = self.chx1b(x1)
        x1 = self.chx1r(x1)
        x2 = self.layer1(x1)
